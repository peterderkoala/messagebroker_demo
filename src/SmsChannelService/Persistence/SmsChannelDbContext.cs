...
namespace NotificationPlatform.SmsChannelService.Persistence;
...
/// </summary>
public sealed class SmsChannelDbContext(DbContextOptions<SmsChannelDbContext> options)
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeliveryAttempt>(entity =>
        {
            ...
            entity.Property(attempt => attempt.Recipient).IsRequired().HasMaxLength(32);
