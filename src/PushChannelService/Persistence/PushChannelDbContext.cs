...
namespace NotificationPlatform.PushChannelService.Persistence;
...
/// </summary>
public sealed class PushChannelDbContext(DbContextOptions<PushChannelDbContext> options)
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeliveryAttempt>(entity =>
        {
            ...
            entity.Property(attempt => attempt.Recipient).IsRequired().HasMaxLength(2048);
